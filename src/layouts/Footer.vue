    ...
    <div class="container">
      <div class="row text-center">
        ...
        <div class="col-6 col-xl-3 col-lg-3 col-md-3 mb-5 my-md-0">
          ...
          <ul class="footer-links">
            <li>
              <a href="https://multividas.com/terms-of-use">Terms of use</a>
            </li>
            <li>
      ...
      <div class="row text-center my-2">
        <div class="col-md-12">
          ...
          <ul class="list-inline social-icons">
            ...
            <li class="list-inline-item cp">
              <a href="https://twitter.com/multividaseng" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <li class="list-inline-item cp">
              <a href="https://github.com/multividas" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
      ...
      <div class="row text-center">
        <div class="col-md-12">
          <p class="footer-copyright text-white">
            ...
            <span class="me-1">{{ new Date().getFullYear() }}</span>
            <span class="me-1">Multividas</span>
            <span class="me-1">|</span>
            <span class="me-1">All rights reserved</span>
            <span class="me-1">|</span>
            <span class="me-1">Made by</span>
            <span class="me-1">
              <a href="https://soulaimaneyahya.com/" target="_blank">
